// js/campeonatos.js
// Gestão e renderização da lista de campeonatos
  ...
  main.innerHTML = `
    ...
    <div id="form-campeonato" class="hidden bg-gray-50 p-6 rounded-lg border border-gray-200 mb-8">
      ...
      <form id="form-campeonato-submit">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Época (ex: 2024/25)</label>
            <input type="text" id="epoca" required
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-handball-red focus:border-handball-red">
          </div>
        </div>
        ...
        <div class="mt-6">
          ...
          <textarea id="descricao" rows="3"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-handball-red focus:border-handball-red"></textarea>
        </div>
    ...
    <div class="overflow-x-auto">
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody id="campeonatos-tbody" class="bg-white divide-y divide-gray-200">
...
async function loadAndRenderTable() {
  ...
  // Delegação de eventos para botões que são criados dinamicamente
